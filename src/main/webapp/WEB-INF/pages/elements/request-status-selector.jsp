...
<div id="request-status-selector">
        ...
        <div class="input-group input-word">
            <span class="input-group-btn">
                ...
                <button id="status-1-button" class="btn btn-default add" type="button">
                    <span class="glyphicon add" aria-hidden="true"></span> Готов
                </button>
                <button id="status-2-button" class="btn btn-default add" type="button">
                    <span class="glyphicon add" aria-hidden="true"></span> Принят
                </button>
                <button id="status-3-button" class="btn btn-default add" type="button">
